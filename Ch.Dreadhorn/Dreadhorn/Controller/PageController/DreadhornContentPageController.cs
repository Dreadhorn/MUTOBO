...
{
    public class DreadhornContentPageController : HomePageController
    {
        ...
        public DreadhornContentPageController(
            IDreadhornContentService contentService, 
            IDreadhornEasterEggService easterEggService) : 
            base(contentService as IMutoboContentService)
        {
        ...
        public override ActionResult Index(ContentModel model)
        {
            ...
            return base.Index<DreadhornContentPage>(new DreadhornContentPage(model.Content)
            {
